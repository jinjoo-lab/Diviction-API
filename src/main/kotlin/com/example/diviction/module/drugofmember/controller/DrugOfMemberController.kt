...
class DrugOfMemberController (
    ...
    fun saveDrugOfMember(
        ...
        drugOfMemberService.saveDrugOfMember(drugOfMemberSaveRequest.member, drugOfMemberSaveRequest.drug)
    }

    @GetMapping("/get/bymember/{memberId}")
    fun getDrugOfMemberByMemberId(@PathVariable memberId : Long) : List<DrugOfMember>
    {
        return drugOfMemberService.getListByMemberId(memberId)
    }

    @GetMapping("/get/bydrug/{drugId}")
    fun getDrugOfMemberByDrugId(@PathVariable drugId : Long) : List<DrugOfMember>
    {
